...
vim.api.nvim_set_keymap("n", "<C-S>", ":Prettier<CR>:lua vim.defer_fn(function() vim.cmd('w') end, 50)<CR>", { noremap = true })
-- Close without saving with Ctrl+Q
vim.api.nvim_set_keymap("n", "<C-Q>", ":q!<CR>", { noremap = true })
vim.api.nvim_set_keymap('n', '<A-c>', '<Cmd>BufferClose<CR>', { silent = true })
vim.api.nvim_set_keymap('n', '<A-s-c>', '<Cmd>BufferRestore<CR>', { silent = true })
